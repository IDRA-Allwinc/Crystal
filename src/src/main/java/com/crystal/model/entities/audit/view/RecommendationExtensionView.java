...
@Entity
@Subselect("SELECT e.id_extension, r.id_recommendation recommendationId, r.is_attended isAttended, uf.id_upload_file_generic fileId, uf.file_name fileName, concat(substring(e.comment, 1,30),'...') extensionComment, date_format(e.end_date, '%d/%m/%Y') endDate " + //, Addition.extensionId2 lastExtensionId
