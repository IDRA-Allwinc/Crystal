...
<script>
    $(document).ready(function () {
        window.showModalFormDlg("#dlgUpModalId", "#FormUpFileEventId");
        var tableId = '#tblUfEventGrid';
        ...
        $('#docfileupload').fileupload({
            ...
            dataType: 'json',
                ...
                try {
                    var scope = angular.element($("#FormUpFileEventId")).scope();
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" data-ng-controller="eventViewDocsController as ct"
        ...
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
                <div data-ng-show="ct.m.isAttended !== true">
                    ...
                    <div class="row">
                        <form id="FormUpFileEventId" name="FormUpFileEventId" class="form-horizontal" role="form"
                            ...
                            <div class="col-xs-8">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpFileEventId.description.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpFileEventId.description.$error.minlength">*Longitud m&iacute;nima de 2 caracteres</span>
                                            <span class="error" ng-show="FormUpFileEventId.description.$error.maxlength">*Longitud m&aacute;xima de 200 caracteres</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <table id="tblUfEventGrid"
                                       data-toggle="table"
                                       data-url="<c:url value='/audit/event/listUfEvent.json' />?eventId={{ct.m.id}}"
                                       data-height="auto"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="eventId" data-visible="false" data-card-visible="false" data-switchable="false">ID requisito</th>
                                        ...
                                        <th data-field="Actions" data-formatter="uploadEventFileFormatter"
                                            data-align="center" data-width="200px" data-events="actionEventEvents">Acci&oacute;n
                                        </th>
                                    </tr>
                                    </thead>
                                </table>
