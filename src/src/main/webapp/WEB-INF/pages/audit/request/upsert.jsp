                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <textarea name="description" ng-model="vm.m.description"
                                                      placeholder="Ingrese la descripci&oacute;n del numeral"
                                                      minlength="8"
                                                      maxlength="2000"
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpRequestId.initDate.$invalid && !FormUpRequestId.initDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
                                        ...
                                        <span class="error"
                                              ng-show="FormUpRequestId.endDate.$invalid && !FormUpRequestId.endDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
