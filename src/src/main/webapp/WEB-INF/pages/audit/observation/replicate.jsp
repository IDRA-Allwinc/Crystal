    ...
    <div class="modal-dialog" style="width:800px" ng-controller="observationController as vm">
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="FormUpObservationAttentionId" name="FormUpObservationAttentionId"
                            ...
                            <div class="row" ng-if="vm.attention.isAttended==false">
                                ...
                                <div class="col-xs-12 form-group">
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpObservationAttentionId.attentionComment.$error.required">*Campo requerido</span>
                                        <span class="error"
                                              ng-show="FormUpObservationAttentionId.attentionComment.$error.minlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                        <span class="error"
                                              ng-show="FormUpObservationAttentionId.attentionComment.$error.maxlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                    </div>
                                </div>

                                <div class="col-xs-12 form-group">
                                    <input type="hidden" id="replicateAs" name="replicateAs" ng-model="vm.m.replicateAs"
                                           ng-required="true" ng-update-hidden/>
                                    <label class="col-xs-3 control-label font-noraml">Replicar como:</label>

                                    <div class="col-xs-8">
                                        <label class="radio-inline"><input type="radio" ng-model="vm.m.replicateAs"
                                                                           ng-value="'<%=Constants.RESPONSIBILITY_R%>'">Promoci&oacute;n</label>
                                        <br/>
                                        <span class="error"
                                              ng-show="FormUpObservationAttentionId.replicateAs.$error.required">*Campo requerido</span>
                                    </div>
                                </div>
