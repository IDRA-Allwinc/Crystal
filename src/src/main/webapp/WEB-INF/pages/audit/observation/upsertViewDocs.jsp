...
<script>
    $(document).ready(function () {
        window.showModalFormDlg("#dlgUpModalId", "#FormUpFileObservationId");
        var tableId = '#tblUfObservationGrid';
        ...
        $('#docfileupload').fileupload({
            ...
            dataType: 'json',
                ...
                try {
                    var scope = angular.element($("#FormUpFileObservationId")).scope();
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" data-ng-controller="observationViewDocsController as ct"
            ...
            <div class="modal-body">
                        ...
                        <div class="col-xs-12">
                            <div class="ibox">
                                <div class="ibox-title navy-bg">
                                    <h5>Subir documentos al pliego de observaciones <b>{{ct.m.number}}</b></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <form id="FormUpFileObservationId" name="FormUpFileObservationId" class="form-horizontal" role="form"
                            ...
                            <div class="col-xs-8">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpFileObservationId.description.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpFileObservationId.description.$error.minlength">*Longitud m&iacute;nima de 2 caracteres</span>
                                            <span class="error" ng-show="FormUpFileObservationId.description.$error.maxlength">*Longitud m&aacute;xima de 200 caracteres</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5>Documentos adicionales del pliego de observaciones <b>{{ct.m.number}}</b></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <table id="tblUfObservationGrid"
                                       data-toggle="table"
                                       data-url="<c:url value='/audit/observation/listUfObservation.json' />?observationId={{ct.m.id}}"
                                       data-height="auto"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="observationId" data-visible="false">ID requisito</th>
