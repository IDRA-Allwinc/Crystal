...
<script>
    $(document).ready(function () {
        window.showModalFormDlg("#dlgUpModalId", "#FormUpObservationId");
    });
</script>
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" ng-controller="observationController as vm">
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5>Informaci&oacute;n del pliego de observaciones</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="FormUpObservationId" name="FormUpObservationId" class="form-horizontal" role="form"
                              ng-init='vm.m = ${(model == null ? "{}" : model)}; vm.urlGetAreas="<c:url value='/previousRequest/request/getAreas.json'/>"; vm.lstSelectedAreas = ${(lstSelectedAreas == null ? "[]" : lstSelectedAreas)}; vm.lstObservationType=${(lstObservationType == null ? "[]" : lstObservationType)}; vm.init(  );'>
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <input type="text" name="number" ng-model="vm.m.number"
                                                   placeholder="Ingrese el numeral del pliego de observaciones"
                                                   minlength="8"
                                                   maxlength="50"
                                                   ng-required="true" class="form-control">
                                        <span class="error"
                                              ng-show="FormUpObservationId.number.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpObservationId.number.$error.minlength">*El campo debe tener entre 8 y 50 caracteres</span>
                                            <span class="error" ng-show="FormUpObservationId.number.$error.maxlength">*El campo debe tener entre 8 y 50 caracteres</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div>
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <span class="error"
                                                          ng-show="FormUpObservationId.initDate.$error.required">*Campo requerido</span>
                                                </div>
                                        <span class="error"
                                              ng-show="FormUpObservationId.initDate.$invalid && !FormUpObservationId.initDate.$pristine">*La fecha debe tener el formato aaaa/mm/dd</span>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div>
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <span class="error"
                                                          ng-show="FormUpObservationId.endDate.$error.required">*Campo requerido</span>
                                                </div>
                                            </div>
                                        <span class="error"
                                              ng-show="FormUpObservationId.endDate.$invalid && !FormUpObservationId.endDate.$pristine">*La fecha debe tener el formato aaaa/mm/dd</span>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" ng-show="up.WaitFor===false"
                        ng-click="vm.validateAll()== false ? up.submit('#FormUpObservationId', '<c:url value='/audit/observation/doUpsert.json' />', FormUpObservationId.$valid):''">
                    Guardar
                </button>
