                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpObservationId.initDate.$invalid && !FormUpObservationId.initDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
                                        ...
                                        <span class="error"
                                              ng-show="FormUpObservationId.endDate.$invalid && !FormUpObservationId.endDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
