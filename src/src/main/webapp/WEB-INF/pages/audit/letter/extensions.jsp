...
<script>
    $(document).ready(function () {
        window.showModalFormDlg("#dlgUpModalId", "#FormUpFileExtensionId");
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" data-ng-controller="extensionRequestController as er"
         data-ng-init='er.m = ${(model == null ? "{}" : model)};'>
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
                <div data-ng-show="er.m.isAttended !== true">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="ibox">
                                <div class="ibox-title navy-bg">
                                    <h5>Subir documentos adicionales al oficio <strong>{{er.m.number}}</strong></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <form id="FormUpFileExtensionId" name="FormUpFileExtensionId" class="form-horizontal" role="form"
                              enctype="multipart/form-data">
                            <input type="hidden" id="id" name="id" ng-model="er.m.id" ng-update-hidden/>
                            <input type="hidden" id="type" name="type" ng-model="er.m.type" ng-update-hidden/>
                            ...
                            <div class="col-xs-8">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-7">
                                        <textarea name="description" rows="3" ng-model="er.m.description"
                                                  placeholder="Ingrese una breve descripci&oacute;n del documento"
                                                  ng-required="true"  ng-minlength="2"
                                                  class="form-control"></textarea>
                                        <span class="error"
                                              ng-show="FormUpFileExtensionId.description.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpFileExtensionId.description.$error.minlength">*Longitud m&iacute;nima de 2 caracteres</span>
                                            <span class="error" ng-show="FormUpFileExtensionId.description.$error.maxlength">*Longitud m&aacute;xima de 200 caracteres</span>
                                        </div>
                                    </div>
                                </div>
                                <div data-ng-show="er.m.description">
                                    <br/>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div ng-show="er.MsgError" class="alert alert-error element-center"
                                                 ng-bind-html="er.MsgError">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div ng-show="er.MsgSuccess" class="alert alert-success element-center"
                                                 ng-bind-html="er.MsgSuccess">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5>Documentos adicionales del oficio {{er.m.number}}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <table id="tblUfRequestAuditGrid"
                                       data-toggle="table"
                                       data-url="<c:url value='/audit/letter/listUfLetter.json' />?letterId={{er.m.id}}"
                                       data-height="auto"
