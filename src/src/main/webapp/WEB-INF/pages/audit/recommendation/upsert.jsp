...
<script>
    $(document).ready(function () {
        window.showModalFormDlg("#dlgUpModalId", "#FormUpRecommendationId");
    });
</script>
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" ng-controller="recommendationController as vm">
        <div class="modal-content animated flipInY">
            <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6" style="padding-top: 40px;">
                        <h4 class="modal-title">Recomendaciones de auditor&iacute;a</h4>
                    </div>
                    <div class="col-xs-3" align="right">
                        <i class="fa fa-hand-o-right modal-icon"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="FormUpRecommendationId" name="FormUpRecommendationId" class="form-horizontal" role="form"
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpRecommendationId.number.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpRecommendationId.number.$error.minlength">*El campo debe tener entre 8 y 50 caracteres</span>
                                            <span class="error" ng-show="FormUpRecommendationId.number.$error.maxlength">*El campo debe tener entre 8 y 50 caracteres</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <span class="error" ng-show="FormUpRecommendationId.description.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpRecommendationId.description.$error.minlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                            <span class="error" ng-show="FormUpRecommendationId.description.$error.maxlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div>
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <span class="error"
                                                          ng-show="FormUpRecommendationId.initDate.$error.required">*Campo requerido</span>
                                                </div>
                                        <span class="error"
                                              ng-show="FormUpRecommendationId.initDate.$invalid && !FormUpRecommendationId.initDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div>
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <span class="error"
                                                          ng-show="FormUpRecommendationId.endDate.$error.required">*Campo requerido</span>
                                                </div>
                                            </div>
                                        <span class="error"
                                              ng-show="FormUpRecommendationId.endDate.$invalid && !FormUpRecommendationId.endDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" ng-show="up.WaitFor===false"
                        ng-click="vm.validateAll()== false ? up.submit('#FormUpRecommendationId', '<c:url value='/audit/recommendation/doUpsert.json' />', FormUpRecommendationId.$valid):''">
                    Guardar
                </button>
