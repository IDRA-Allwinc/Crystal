...
<script>
    $(document).ready(function () {
        window.showModalFormDlg("#dlgUpModalId", "#FormUpResponsibilityId");
    });
</script>
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" ng-controller="responsibilityController as vm">
        <div class="modal-content animated flipInY">
            <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6" style="padding-top: 40px;">
                        <h4 class="modal-title">Promociones de responsabilidad de auditor&iacute;a</h4>
                    </div>
            ...
            <div class="modal-body">
                    ...
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5>Informaci&oacute;n de la promoci&oacute;n</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="FormUpResponsibilityId" name="FormUpResponsibilityId" class="form-horizontal" role="form"
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpResponsibilityId.number.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpResponsibilityId.number.$error.minlength">*El campo debe tener entre 8 y 50 caracteres</span>
                                            <span class="error" ng-show="FormUpResponsibilityId.number.$error.maxlength">*El campo debe tener entre 8 y 50 caracteres</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <textarea name="description" ng-model="vm.m.description"
                                                      placeholder="Ingrese la descripci&oacute;n de la promoci&oacute;n"
                                                      minlength="8"
                                                      maxlength="2000"
                                                      ng-required="true" class="form-control"></textarea>
                                            <span class="error" ng-show="FormUpResponsibilityId.description.$error.required">*Campo requerido</span>
                                            <span class="error" ng-show="FormUpResponsibilityId.description.$error.minlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                            <span class="error" ng-show="FormUpResponsibilityId.description.$error.maxlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div>
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <span class="error"
                                                          ng-show="FormUpResponsibilityId.initDate.$error.required">*Campo requerido</span>
                                                </div>
                                        <span class="error"
                                              ng-show="FormUpResponsibilityId.initDate.$invalid && !FormUpResponsibilityId.initDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div>
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <span class="error"
                                                          ng-show="FormUpResponsibilityId.endDate.$error.required">*Campo requerido</span>
                                                </div>
                                            </div>
                                        <span class="error"
                                              ng-show="FormUpResponsibilityId.endDate.$invalid && !FormUpResponsibilityId.endDate.$pristine">*La fecha debe tener el formato dd/mm/aaaa</span>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" ng-show="up.WaitFor===false"
                        ng-click="vm.validateAll()== false ? up.submit('#FormUpResponsibilityId', '<c:url value='/audit/responsibility/doUpsert.json' />', FormUpResponsibilityId.$valid):''">
                    Guardar
                </button>
