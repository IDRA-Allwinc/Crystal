                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpResponsibilityId.initDate.$invalid && !FormUpResponsibilityId.initDate.$pristine">*La fecha debe tener el formato aaaa/mm/dd</span>
                                        ...
                                        <span class="error"
                                              ng-show="FormUpResponsibilityId.endDate.$invalid && !FormUpResponsibilityId.endDate.$pristine">*La fecha debe tener el formato aaaa/mm/dd</span>
