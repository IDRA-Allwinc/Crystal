...
<script>
    $(document).ready(function () {
        window.showModalFormDlg("#dlgUpModalId", "#FormUpCommentId");
    });
</script>
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" ng-controller="commentController as vm">
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5>Informaci&oacute;n de la observaci&oacute;n</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="FormUpCommentId" name="FormUpCommentId" class="form-horizontal" role="form"
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <textarea name="description" ng-model="vm.m.description"
                                                      placeholder="Ingrese la descripci&oacute;n de la observaci&oacute;n"
                                                      minlength="8"
                                                      maxlength="2000"
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" ng-show="up.WaitFor===false"
                        ng-click="vm.validateAll()== false ? up.submit('#FormUpCommentId', '<c:url value='/audit/comment/doUpsert.json' />', FormUpCommentId.$valid):''">
                    Guardar
                </button>
