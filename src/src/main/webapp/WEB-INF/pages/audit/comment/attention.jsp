        ...
        <div class="modal-content animated flipInY">
                    ...
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5 ng-if="vm.m.isAttended==false">Indicar atenci&oacute;n de la observaci&oacute;n n&uacute;mero <b>{{vm.m.commentNumber}}</b></h5>
                                <h5 ng-if="vm.m.isAttended==true">Informaci&oacute;n de atenci&oacute;n de la observaci&oacute;n n&uacute;mero <b>{{vm.m.commentNumber}}</b></h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form id="FormUpCommentAttentionId" name="FormUpCommentAttentionId" class="form-horizontal" role="form"
                            ...
                            <div class="panel panel-primary" ng-if="vm.m.isAttended==true">
                                <div class="panel-heading">
                                    Observaci&oacute;n atendida n&uacute;mero <b>{{vm.m.commentNumber}}</b>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            ...
                                            {{vm.m.replicateAs === '<%=Constants.RECOMMENDATION_R%>' ? "recomendaci&oacute;n" : ""}}
                                            {{vm.m.replicateAs === '<%=Constants.OBSERVATION_R%>' ? "pliego de observaciones" : ""}}
            ...
            <div class="modal-footer" ng-if="vm.m.isAttended==false">
                ...
                <button class="btn btn-primary " ng-disabled="up.WaitFor==true"
                        ng-click="up.submit('#FormUpCommentAttentionId', '<c:url value='/audit/comment/doAttention.json' />', FormUpCommentAttentionId.$valid)">
                    Guardar
                </button>
            </div>
        </div>
