...
<script>
    ...
    function actionsFormatterCommentExtension(value, row, index) {
        ...
        if (row.attended !== true && row.id==row.lastExtensionId)
            arr.push('<button class="btn btn-danger dim act-ext-comment-delete btn-tiny" data-toggle="tooltip" data-placement="top" title="Eliminar prorroga" type="button"><i class="fa fa-times-circle"></i></button>');
            ...
            <div class="modal-body">
                        ...
                        <div class="col-xs-12">
                            <div class="ibox">
                                <div class="ibox-title navy-bg">
                                    <h5>Agregar prorroga a la observaci&oacute;n <b>{{vm.m.number}}</b></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5>Prorrogas para la observaci&oacute;n <b>{{vm.m.number}}</b></h5>
                            </div>
                        </div>
                    </div>
                </div>
