...
<script>
    ...
    function actionsFormatterCommentExtension(value, row, index) {
        var arr = [];
        ...
        if (row.attended !== true)//&& row.id==row.lastExtensionId)
            arr.push('<button class="btn btn-danger dim act-ext-comment-delete btn-tiny" data-toggle="tooltip" data-placement="top" title="Eliminar pr&oacute;rroga" type="button"><i class="fa fa-times-circle"></i></button>');
    ...
    $(document).ready(function () {
        ...
        window.showModalFormDlg("#dlgUpModalId", "#FormUpFileExtensionComment");
        var tableId = '#tblUfExtensionCommentGrid';
        ...
        var scope = angular.element($("#FormUpFileExtensionComment")).scope();
        ...
        window.actionEventsCommentExtension = {
            'click .act-ext-comment-delete': function (e, value, row) {
                window.showObsoleteParam({
                    commentId: row.commentId,
                    extensionId: row.id
                }, "#angJsjqGridIdComment", "<c:url value='/audit/comment/doDeleteExtension.json' />", "#tblUfExtensionCommentGrid", undefined, undefined,scope.vm.refreshExtensionComment);
            },
        ...
        $('#dlgUpModalId').on('hidden.bs.modal', function () {
            scope.vm.refreshParentGrid("#tblGridComment");
        })
...
<div class="modal inmodal" id="dlgUpModalId" tabindex="-1" ng-controller="upsertController as up" role="dialog"
    ...
    <div class="modal-dialog" style="width:960px" data-ng-controller="extensionCommentController as vm"
         data-ng-init='vm.m = ${(model == null ? "{}" : model)};
            vm.urlRefresh="<c:url value='/audit/comment/refresh.json'/>";'>
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-body">
                        ...
                        <div class="col-xs-12">
                            <div class="ibox">
                                <div class="ibox-title navy-bg">
                                    <h5>Agregar pr&oacute;rroga a la observaci&oacute;n <b>{{vm.m.number}}</b></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <form id="FormUpFileExtensionComment" name="FormUpFileExtensionComment" class="form-horizontal"
                              role="form"
                            ...
                            <div class="col-xs-9">
                                ...
                                <div class="row">
                                            ...
                                            <div>
                                                <p class="input-group">
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <span class="error"
                                                          ng-show="FormUpFileExtensionComment.endDate.$error.required">*Campo requerido</span>
                                                <span class="error"
                                                      ng-show="FormUpFileExtensionComment.endDate.$invalid && !FormUpFileExtensionComment.endDate.$pristine">*La fecha debe tener el formato aaaa/mm/dd</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-11">
                                        ...
                                        <span class="error"
                                              ng-show="FormUpFileExtensionComment.extensionComment.$error.required">*Campo requerido</span>
                                            <span class="error"
                                                  ng-show="FormUpFileExtensionComment.extensionComment.$error.minlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                            <span class="error"
                                                  ng-show="FormUpFileExtensionComment.extensionComment.$error.maxlength">*El campo debe tener entre 8 y 2000 caracteres</span>
                                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="ibox">
                            <div class="ibox-title navy-bg">
                                <h5>Pr&oacute;rrogas para la observaci&oacute;n <b>{{vm.m.number}}</b></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <table id="tblUfExtensionCommentGrid"
                                       data-toggle="table"
                                       data-url="<c:url value='/audit/comment/extension/list.json' />?id={{vm.m.id}}"
                                       data-height="auto"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="commentId" data-visible="false" data-card-visible="false"
                                        ...
                                        <th data-field="Actions" data-formatter="actionsFormatterCommentExtension"
                                            data-align="center" data-width="200px"
                                            data-events="actionEventsCommentExtension">Acci&oacute;n
                                        </th>
                                    </tr>
                                    </thead>
                                </table>
            ...
            <div class="modal-footer">
                <button class="btn btn-default" ng-click="vm.refreshParentGrid('#tblGridComment'); up.cancel();">
                    Regresar
                </button>
            </div>
        </div>
