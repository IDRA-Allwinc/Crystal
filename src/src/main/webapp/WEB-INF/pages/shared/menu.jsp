...
<div scroll="no" ng-app="crystal">
    <div data-ng-controller="menuController as mn">
        <form id="logout" action="<c:url value="/logout" />" method="post"
              ng-init="mn.checkUrl= '<c:url value="/session/checkout.json"/>'; mn.extendUrl= '<c:url value="/session/extend.json"/>'; mn.logoutUrl= 'logout'; init();">
...
<%--&lt;%&ndash;<sec:authorize access="hasAuthority('DGPOP')">&ndash;%&gt;--%>
<%--&lt;%&ndash;<li>&ndash;%&gt;--%>
<%--&lt;%&ndash;<a href="#"><i class="fa fa-th"></i> <span class="nav-label">Reportes</span> </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;<ul class="nav nav-second-level">&ndash;%&gt;--%>
<%--&lt;%&ndash;<li class="active">&ndash;%&gt;--%>
<%--&lt;%&ndash;<a href="">&ndash;%&gt;--%>
<%--&lt;%&ndash;<i class="fa fa-shield"></i>Auditor&iacute;as&ndash;%&gt;--%>
<%--&lt;%&ndash;</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;</li>&ndash;%&gt;--%>
<%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;</li>&ndash;%&gt;--%>
