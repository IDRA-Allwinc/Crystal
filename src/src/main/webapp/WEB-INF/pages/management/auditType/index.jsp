...
<head>
    ...
    <script src="${pageContext.request.contextPath}/assets/scripts/client-app/ctrl/management/auditType.ctrl.js"></script>

    <script type="text/javascript">
        window.upsert = function (id) {
            window.showUpsert(id, "#angJsjqGridId", '<c:url value='/management/auditType/upsert.html' />', "#tblGrid");
        };
    </script>
    ...
    <script type="text/javascript">
        ...
        function actionsFormatter(value, row, index) {
            return [
                '<button class="btn btn-success dim act-edit btn-tiny" data-toggle="tooltip" data-placement="top" title="Editar informaci&oacute;n del tipo de auditor&iacute;a" type="button"><i class="fa fa-edit"></i></button>',
                '<button class="btn btn-danger dim act-delete btn-tiny" data-toggle="tooltip" data-placement="top" title="Eliminar tipo de auditor&iacute;a" type="button"><i class="fa fa-times-circle"></i></button>'
            ].join('');
        }

        window.upsert = function (id) {
            window.showUpsert(id, "#angJsjqGridId", "<c:url value='/management/auditType/upsert.json' />", "#tblGrid");
        };
        ...
        window.actionEvents = {
            ...
            'click .act-delete': function (e, value, row) {
                window.showObsolete(row.id, "#angJsjqGridId", "<c:url value='/management/auditType/doObsolete.json' />", "#tblGrid");
            }
        };
    </script>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-12">
                <h2>Tipos de auditor&iacute;a</h2>
                <ol class="breadcrumb">
                    <li>
                        <a href="">Cat&aacute;logos</a>
                    </li>
                    <li>
                        <a href="">Tipos de auditor&iacute;a</a>
                    </li>
                </ol>
                <br />
                <div class="alert alert-info alert-10">
                    <i class="fa fa-lightbulb-o fa-lg"></i> &nbsp En esta secci&oacute;n puede administrar tipos de auditor&iacute;a.
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <table id="tblGrid"
                                   data-toggle="table"
                                   data-url="<c:url value='/management/auditType/list.json' />"
                                   data-height="auto"
