(function () {
    ...
    angular
        ...
        .controller('responsibilityController', responsibilityController);

    responsibilityController.$inject = ["$scope", "$rootScope", "$sce", "$timeout", "$http"];

    function responsibilityController($scope, $rootScope, $sce, $timeout, $http) {
        var vm = this;
