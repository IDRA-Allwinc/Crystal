(function () {
    ...
    angular
        ...
        .controller('responsibilityViewDocsController', responsibilityViewDocsController);

    responsibilityViewDocsController.$inject = ["$scope", "$sce", "$timeout"];

    function responsibilityViewDocsController($scope, $sce, $timeout) {
        var vm = this;
        vm.m = {};
