(function () {
    ...
    angular
        ...
        .controller('eventViewDocsController', eventViewDocsController);

    eventViewDocsController.$inject = ["$scope", "$sce", "$timeout"];

    function eventViewDocsController($scope, $sce, $timeout) {
        var vm = this;
        vm.m = {};
